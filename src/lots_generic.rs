...
mod me_i {
    ...
    struct Weapon<T: Zoomer, R: BulletBox, B: FrontCatch, L: Muzzle> {
        zoomer: T,
        bullet_box: R,
        front_catch: B,
        muzzle: L,
    }
    trait Zoomer: WeaponComponent {
        fn zoom_in(&self);
        fn zoom_out(&self);
    }
    trait BulletBox: WeaponComponent {
        fn reload(&self);
        fn shooting(&self);
    }
    trait FrontCatch: WeaponComponent {
        fn catch(&self);
        fn release(&self);
        fn under_fire(&self);
    }
    trait Muzzle: WeaponComponent {
        fn under_fire(&self);
    }
    trait WeaponComponent {
        fn install(&self);
        fn remove(&self);
        fn switch(&self);
        fn under_fire(&self);
    ...
    struct AK47 { 
        weapon_comp : Weapon<AK47Zoomer, AK47BulletBox, AK47FrontCatch, AK47Muzzle>
    }
    struct AK47Zoomer;
    impl Zoomer for AK47Zoomer {
        fn zoom_in(&self) {
            todo!()
        }
        fn zoom_out(&self) {
    ...
    impl WeaponComponent for AK47Zoomer {
        fn install(&self) {
            todo!()
        }
        fn remove(&self) {
    ...
    struct AK47BulletBox;
    impl BulletBox for AK47BulletBox {
        fn reload(&self) {
            todo!()
        }
        fn shooting(&self) {
    ...
    impl WeaponComponent for AK47BulletBox {
        fn install(&self) {
            todo!()
        }
        fn remove(&self) {
    ...
    struct AK47FrontCatch;
    impl FrontCatch for AK47FrontCatch {
        fn catch(&self) {
            todo!()
        }
        fn release(&self) {
    ...
    impl WeaponComponent for AK47FrontCatch {
        fn install(&self) {
            todo!()
        }
        fn remove(&self) {
    ...
    struct AK47Muzzle;
    impl Muzzle for AK47Muzzle {
        fn under_fire(&self) {
            todo!()
        }
    }
    impl WeaponComponent for AK47Muzzle {
        fn install(&self) {
            todo!()
        }
        fn remove(&self) {
